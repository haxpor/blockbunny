...
class B2DVars {
    companion object {
        ...
        const val BIT_BOMB: Short= 64
        const val BIT_TOP_PLATFORM: Short = 128
        const val BIT_BOTTOM_PLATFORM: Short = 256
        const val BIT_LINE1_BLOCK: Short = 512
        const val BIT_LINE2_BLOCK: Short = 1024
    }
}